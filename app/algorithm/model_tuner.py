...
def tune_hyperparameters(data, data_schema, num_trials, hyper_param_path, hpt_results_path):  
    ...
    train_data_tup, valid_data_tup, preprocess_pipe = model_trainer.preprocess_data(train_data, valid_data, data_schema)             
    ...
    def objective(**hyperparameters):
        ...
        model, history = model_trainer.train_model(train_data_tup, valid_data_tup, hyperparameters, verbose=0) 
        score = np.round(history.history["val_loss"][-1], 4)  # mse
